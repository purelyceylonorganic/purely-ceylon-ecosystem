export const shipmentShippedTemplate = (buyerName: string): string => {
  return `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin:0;padding:0;background:#f5f5f5;font-family:Arial,sans-serif;">
  ...
  <div style="max-width:700px;margin:30px auto;background:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 4px 12px rgba(0,0,0,.08);">
    ...
    <div style="padding:40px;">
      ...
      <p>Your shipment has been dispatched successfully.</p>
      <p>Tracking information will be shared shortly.</p>
      <p>Thank you for choosing Purely Ceylon.</p>
    </div>
